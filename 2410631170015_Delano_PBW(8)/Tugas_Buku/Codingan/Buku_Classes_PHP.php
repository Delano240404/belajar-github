...
// ============================================================
// CLASS AUTH - Autentikasi Login/Logout (OOP)
// ============================================================
...
class Auth {
    ...
    public function login(string $username, string $password): array {
        ...
        try {
            $stmt = $this->pdo->prepare("SELECT id, username, password, nama_lengkap FROM users WHERE username = ? LIMIT 1");
     ...
     *
     * @param int $timeout Batas waktu inaktif dalam detik (default 2 jam)
     * @return bool
     */
    public function isLoggedIn(int $timeout = 7200): bool {
    ...
    /**
     * Paksa cek login — redirect ke login.php jika belum/tidak login
     */
    ...
    /**
     * Proses logout: hancurkan session & redirect
     */
